...
- `services.postsrsd` now automatically integrates with the local Postfix instance. This behavior can disabled using the [services.postsrsd.configurePostfix](#opt-services.postsrsd.configurePostfix) option.
